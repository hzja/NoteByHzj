<a name="Y4GbU"></a>
## 0X00 原理
原理就是，读取本地微信文件夹中的config目录下的AccInfo.dat文件<br />![image.png](https://cdn.nlark.com/yuque/0/2022/png/396745/1652446240672-d4531f38-8a37-433b-9cc0-03b5f3565bb7.png#clientId=u6bbe2c81-ee10-4&from=paste&height=594&id=u9936a8a6&originHeight=1484&originWidth=2254&originalType=binary&ratio=1&rotation=0&showTitle=false&size=394093&status=done&style=shadow&taskId=u4da4f8f7-9878-49a1-8a94-e6cf8682d53&title=&width=901.6)<br />AccInfo.dat文件内容如下图<br />![image.png](https://cdn.nlark.com/yuque/0/2022/png/396745/1652446399342-b2558447-789e-44a7-9df5-10cc2a936577.png#clientId=u6bbe2c81-ee10-4&from=paste&height=714&id=u57939be9&originHeight=1784&originWidth=3343&originalType=binary&ratio=1&rotation=0&showTitle=false&size=293351&status=done&style=shadow&taskId=uad8b1973-fa3a-44e0-82eb-e5096907319&title=&width=1337.2)<br />这个Dat文件中包含了手机号，微信ID，微信号，昵称和城市，绑定邮箱等信息
<a name="Cuziz"></a>
## 0X01 Python脚本处理
**自动化脚本**<br />脚本代码来自：[https://github.com/ecat-sec/wechat_info_collect](https://github.com/ecat-sec/wechat_info_collect)<br />![image.png](https://cdn.nlark.com/yuque/0/2022/png/396745/1652445726333-8c3a8a7b-15d7-42d4-95ac-10b52813bfa1.png#clientId=u6bbe2c81-ee10-4&from=paste&height=236&id=u42970da9&originHeight=589&originWidth=2313&originalType=binary&ratio=1&rotation=0&showTitle=false&size=106473&status=done&style=shadow&taskId=u33e5b68d-a9dc-425b-97fe-52dc0c741fe&title=&width=925.2)
```python
# -*- coding: utf-8 -*-
import getpass
import re
