...
CMy6Dlg::CMy6Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMy6Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMy6Dlg)
...
void CMy6Dlg::OnButton3() 
{
	// TODO: Add your control notification handler code here
	OnOK();
}

void CMy6Dlg::OnButton4() 
{
	// TODO: Add your control notification handler code here
	CString s;
