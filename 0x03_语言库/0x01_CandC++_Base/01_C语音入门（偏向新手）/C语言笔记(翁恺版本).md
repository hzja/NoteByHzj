...
<a name="3d7e9312"></a>
### ![](./img/1650391544949-65250fa3-b907-44c4-aeba-fdfea2391080.jpeg)
...
1. _&yptr  ->_(&yptr) -> *(yptr的地址) ->得到那个地址上的变量 ->yptr
...
4. 
   ...
   2. 可以修改成char _a[]，本质上就相当于a[0]--->char_
...
4. 
   ...
   1. int strcmp(const char _s1,const char _s2);
...
6. 
   ...
   1. char_strcpy(char_restrict dst,const char *restrict src);
   2. 把src的字符串拷贝到dst
7. 
...
11. 
   ...
   1. 
      ...
      1. char_dst = (char_)malloc(strlen(src)+1); //之所以加一是因为结尾会自带\0，所以需要多一个位置
      2. strcpy(dst,src);
12. 
strcat
...
13. 
   ...
   1. char_strcat(char _restrict s1,const char *restrict s2);
...
15. 
   ...
   1. 字符串中找字符
   2. char_strchr(const char _s,int c);表示从左边找过来
   3. char_strrchr(const char_s,int c);表示从右边找过来
   4. 返回NULL则表示没有找到
   5. 如何寻找第二个？寻找第二个的方法：
...
3. 
   ...
   1. 
      ...
      1. char_ strstr(const char _s1,const char *s2);
4. 
...
5. 
   ...
   1. 
      ...
      1. char_strcasestr(const char _s1,const char *s2);
...
4. 
   ...
   1. char_ strncpy(char_restict dst, const char* restrict src,size_t n);
   2. char_ strncat(char_restict s1, const char* restrict s2,size_t n);
   3. size_t n表示最多能够接受多少个n个字符，多了就直接掐掉
   4. int strncmp(const char _s1,const char _s2,size_t n);
...
3. p1 = (struct point){5,10}; [//相当于p1.x](//xn--p1-062cl47dy60a.x) = 5;p1.y = 10;
4. p1 = p2;  [//相当于p1.x](//xn--p1-062cl47dy60a.x) = p2.x;p1.y = p2.y;
5. 数组无法做这两种运算！但结构可以
...
3. 
   ...
   1. 丰田汽车的案子(ks)  这里给出传送门(想知道的可以看看)：[https://www.sohu.com/a/133455549_464086](https://www.sohu.com/a/133455549_464086)
4. 
...
1. size_t fread(void_restrict ptr,size_t size,size_t nitems,FILE_restrict stream);
2. size_t fwrite(const void_restruct ptr,size_t size,size_t nitems,FILE_restrict stream);
3. 注意FILE指针是最后一个参数
4. 返回的是成功读写的字节数
...
![](./img/1651906325676-bfeeba49-131d-4bdb-9a40-9089f935045e.jpeg)
...
![](./img/1651906793603-4bbd63a1-bdbd-4637-96f6-185a8772f7a8.jpeg)
...
![](./img/1651907013941-e2a8f1a4-ae26-4533-abc5-ff8033cfa46e.jpeg)
...
![](./img/1651908671100-63c027d3-2140-4a69-a97a-6790a9ffdb9c.jpeg)
...
4. int_array_at(Array_a,int index);访问数组某个单元
...
![](./img/1651985888978-480d4532-2d99-493c-ad30-36489f6541ca.png)
