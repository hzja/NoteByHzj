Python 动态图表<br />「**Pandas_Alive**」不仅包含动态条形图，还可以绘制**动态曲线图、气泡图、饼状图、地图**等。<br />同样也是几行代码就能完成动态图表的绘制。<br />GitHub地址：<br />_[https://github.com/JackMcKew/pandas_alive](https://github.com/JackMcKew/pandas_alive)_<br />使用文档：_[https://jackmckew.github.io/pandas_alive/](https://jackmckew.github.io/pandas_alive/)_<br />**安装版本建议是0.2.3**，**matplotlib版本是3.2.1**。<br />同时需自行安装tqdm(显示进度条)和descartes(绘制地图相关库)。<br />要不然会出现报错，估计是作者的requestment.txt没包含这两个库。<br />成功安装后就可以引入这个第三方库，直接选择加载本地文件。
```python
import pandas_alive
import pandas as pd
...
```
生成了一个GIF图，具体如下。<br />![](./img/1608389348266-b152ed17-f787-4cad-beb9-5501064cdd75.gif)<br />刚开始学习这个库的时候，可以**减少数据**，这样**生成GIF的时间就会快一些**。<br />比如在接下来的使用中，基本都只选取了20天左右的数据。<br />![](./img/1608389348286-539e4ad1-040b-4985-ba91-d3732cbb4ed2.png)<br />对于其他图表，可以查看官方文档的API说明，得以了解。
<a name="4c18aa6c"></a>
### 1、动态条形图
```python
...
```
![](./img/1608389348310-e5f0ea0a-59b8-411c-be4f-b49d150a51ed.gif)
<a name="ZtAYJ"></a>
### 2、动态柱状图
```python
covid_df = pd.read_csv('data/covid19.csv', index_col=0, parse_dates=[0])
...
```
![](./img/1608389348400-08ef625c-a0d9-41cf-8ed5-94e4a351848b.gif)
<a name="yW3UI"></a>
### 3、动态曲线图
```python
covid_df = pd.read_csv('data/covid19.csv', index_col=0, parse_dates=[0])
...
```
![640.gif](./img/1608389612170-a0b37cf3-3657-4bc5-9744-0f68b2c19deb.gif)
<a name="rUhNE"></a>
### 4、动态面积图
```python
covid_df = pd.read_csv('data/covid19.csv', index_col=0, parse_dates=[0])
...
```
![](./img/1608389348424-5149fce0-4342-41a4-acc5-4ee6538958fc.gif)
<a name="hU4ap"></a>
### 5、动态散点图
```python
...
```
![640.gif](./img/1608390409120-471b177d-3cbe-4c25-ac77-6e4342b475c1.gif)
<a name="uZO4S"></a>
### 6、动态饼状图
```python
covid_df = pd.read_csv('data/covid19.csv', index_col=0, parse_dates=[0])
...
```
![](./img/1608389348366-d85c6535-6395-4241-974f-a433a5fe855a.gif)
<a name="BWcY8"></a>
### 7、动态气泡图
```python
...
```
![](./img/1608389348557-13270290-2c83-40a9-a684-80cd844ac2b6.gif)
<a name="f503520d"></a>
### 8、地理空间点图表
```python
import geopandas
...
```
![640.gif](./img/1608390481286-9111c1c0-3537-42bd-b5ef-879c4827b81f.gif)
<a name="nAkXC"></a>
### 9、多边形地理图表
```python
import geopandas
...
map_chart = result.plot_animated(filename='examples/example-geo-polygon-chart.gif',
                                 basemap_format={'source': contextily.providers.Stamen.Terrain})
```
![](./img/1608389348389-abdef468-0b54-4d41-9072-e76deeb64861.gif)
<a name="bcc163e9"></a>
### 10、多个动态图表
```python
covid_df = pd.read_csv('data/covid19.csv', index_col=0, parse_dates=[0])
...
```
![640.gif](./img/1608390540675-b761199e-68da-4d84-a780-885f6d60d7ae.gif)
<a name="8f3802c9"></a>
### 11、城市人口
```python
def population():
...
```
<br />![](./img/1608389348638-d5e6286f-6479-43ba-baee-6b325ebaf8ca.gif)
...
```
![640.gif](./img/1608390728457-ec5281a4-7969-44f5-b1d8-9c099bce18b0.gif)
<a name="yYjJB"></a>
### 13、新南威尔斯州COVID可视化
```python
def nsw():
...
```
![640.gif](./img/1608390776299-8eed968d-bdb1-417d-95c3-4161d1c1d660.gif)
<a name="cpUDG"></a>
### 14、意大利COVID可视化
```python
def italy():
...
```
![640.gif](./img/1608390815751-736bb0b2-1f2b-47cf-92b6-e0f50ad7843a.gif)
<a name="YEmJR"></a>
### 15、单摆运动
```python
def simple():
    ...
    def pendulum(t):
        ...
        plt.close()
```
![640.gif](./img/1608390870571-6c9fbb1a-7c3c-4107-85ce-583a852eed4a.gif)<br />最后如果想完成**中文动态图表**的制作，加入中文显示代码即可。
```python
# 中文显示
...
pandas_alive.animate_multiple_plots('examples/yuhuanshui.gif',
                                    ...
                                    title='我是余欢水演职人员热度排行')
```
还是使用演员的**百度指数**数据。<br />![640.gif](./img/1608390901667-7bbdead7-901c-4546-baa1-eb8e4f45fe77.gif)
