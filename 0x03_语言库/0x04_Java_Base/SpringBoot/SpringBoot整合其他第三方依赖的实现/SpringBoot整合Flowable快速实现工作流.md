JavaSpringBootFlowable<br />流程引擎，也算是一个比较常见的工具了，在日常的很多开发中都会用到，当然用的最多的就是 OA 系统了，但是在一些非 OA 系统中，也会涉及到，比如一个 CRM 中，可能会有合同管理的需求，合同的审批，也是需要流程引擎的。<br />来简单聊聊流程引擎，顺便写一个简单的例子，一起来感受下流程引擎。
<a name="f4Kjm"></a>
## 1、流程引擎介绍
