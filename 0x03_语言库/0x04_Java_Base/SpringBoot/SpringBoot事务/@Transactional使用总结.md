...
<a name="Y8ayC"></a>
### 事务隔离级别
前面已经了解了数据库的事务隔离级别，再来理解 Spring 的事务隔离级别就容易多了。<br />`TransactionDefinition` 中一共定义了 5 种事务隔离级别：
