...
<a name="utmDI"></a>
### 2.2 NioEventLoop 剖析
NioEventLoop 线程不仅要处理 IO 事件，还要处理 Task（包括普通任务和定时任务），<br />提交任务代码 `io.netty.util.concurrent.SingleThreadEventExecutor#execute`
```java
...
参考下图<br />![image.png](https://cdn.nlark.com/yuque/0/2023/png/396745/1698396503586-ba0ccf7a-9306-4906-8e08-0ab3cc01cbdb.png#averageHue=%23f9f9f6&clientId=u3f438bb7-d88d-4&from=paste&height=452&id=ud6c459a8&originHeight=1130&originWidth=2149&originalType=binary&ratio=2.5&rotation=0&showTitle=false&size=806315&status=done&style=none&taskId=u1bd03d2e-bb03-4158-aac7-4ca9d76ca62&title=&width=859.6)<br />`io.netty.channel.nio.NioEventLoop#select`
```java
