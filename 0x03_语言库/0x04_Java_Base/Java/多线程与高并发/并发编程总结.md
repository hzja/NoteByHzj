...
<a name="TxLfA"></a>
#### Or 聚合
Or 聚合代表只要多个任务中有一个完成了，就可以继续下面的任务。<br />主要包含 applyToEither、acceptEither、runAfterEither ，以及他们对应的带 async 的异步方法，区别和上面一样，不再举例了。
<a name="Nak91"></a>
##### 回调/异常处理
